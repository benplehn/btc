...
def parse_args():
    ...
    p.add_argument("--top-decay-min", type=float, default=0.0, help="Décroissance annuelle min de la bande haute.")
    p.add_argument("--top-decay-max", type=float, default=0.05, help="Décroissance annuelle max de la bande haute.")
    p.add_argument("--top-decay-step", type=float, default=0.01, help="Pas de décroissance annuelle.")
...
def main():
    ...
    cfg = RainbowOnlyConfig(
        ...
        rainbow_top_decay=float(best.get("rainbow_top_decay", 0.0)),
    )
